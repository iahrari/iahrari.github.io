...
**Stack:** Java, Spring Boot, Spring Security, AWS (EKS, Lambda, SQS, IAM, DynamoDB, Cognito), Plaid API, Redis, Grafana, Prometheus, Kibana APM, Kafka, PostgreSQL, Debezium, Kubernetes, Github Actions, Jira, MariaDB, Flagsmith, git-crypt
